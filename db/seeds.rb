...
puts "#{Post.count}"
uniquePost = Post.find_or_create_by(title: "This title is unique", body: "This body is unique")
puts "#{Post.count}"

puts "#{Comment.count}"
Comment.find_or_create_by(post: uniquePost, body: "This is a unique comment")
puts "#{Comment.count}"
