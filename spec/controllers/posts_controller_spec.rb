...
#my_topic.posts - posts refers to the table name which is why it's plural
  ...
  #we add context for a guest (unsigned-in) user. Context organizes tests based on the state of the object
  context "guest user" do

  #we define show test which allows guests to view posts in Bloccit
...
#we define tests for the other CRUD actions. We wont allow guests to access the create, new, edit, update or destroy actions
    describe "GET new" do
      it "returns http redirect" do
        get :new, topic_id: my_topic.id
#we expect guests to be redirected if they attempt to do any CRUD actions
...
#we wrap our existing specs in a context so that they become our signed-in user specs
